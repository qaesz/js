...
var cw=null,ct=null,num="0";
var cwx=plus.webview.currentWebview();
mui.back = function() {
cwx.canBack(function(e){
if(e.canBack==true){
	cwx.back();
}
if(e.canBack==false){
	plus.nativeUI.confirm( "您确定要退出当前应用吗?", function(e){
...
//https://raw.githubusercontent.com/qaesz/test/master/+文件名
